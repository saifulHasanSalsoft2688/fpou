    ...
    return (
        <>
            <AuthLayout authTitle='Password Recovery' authPara='An email has been sent to you with a verification code.' backOption={true}>
                <form>
                    <CustomInput required id='verificationCode' type='number' placeholder='Enter Verification Code' labelClass='mainLabel' inputClass='mainInput' onChange={(event) => {
                    ...
                    <div className="mt-4 text-center">
                        <CustomButton type='button' variant='primaryButton' text='Continue' className="gradientBtn" onClick={handleClick} />
                    </div>
                </form>
            </AuthLayout>
        </>
